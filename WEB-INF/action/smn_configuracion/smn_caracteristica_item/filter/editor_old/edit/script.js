...
<rows>selectSmnRelItemAlmacenId('${fld:smn_rel_item_almacen_id}','${fld:smn_caracteristica_item_id}');</rows> 
<rows>selectSmnRelItemCodImpuestoId('${fld:smn_rel_item_cod_impuesto_id}','${fld:smn_caracteristica_item_id}');</rows> 
