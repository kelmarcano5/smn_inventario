SELECT
	...
	case when smn_inventario.smn_valoracion_conteo_fisico.vcf_lote is null then 0 else smn_inventario.smn_valoracion_conteo_fisico.vcf_lote end as vcf_lote,
