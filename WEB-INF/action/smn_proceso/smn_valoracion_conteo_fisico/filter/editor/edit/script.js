...
if ('${fld:smn_moneda_rf}' != '') {
	...
	document.getElementById("costoma").style.display='';
	document.getElementById("montoma").style.display='';
	document.getElementById('vcf_monto_ml').disabled = true;
	document.getElementById('vcf_monto_ma').disabled = true;
}else{
	document.getElementById("tasa").style.display='none';
	document.getElementById("costoma").style.display='none';
	document.getElementById("montoma").style.display='none';
}
 
document.getElementById('smn_almacen_rf').disabled = true;
document.getElementById('smn_conteo_id').disabled = true;
document.getElementById('smn_documento_id').disabled = true;
document.getElementById('vcf_numero_documento').disabled = true;
document.getElementById('smn_item_id').disabled = true;
document.getElementById('vcf_cantidad_contada').disabled = true;
document.getElementById('vcf_cantidad_existencia').disabled = true;
document.getElementById('vcf_cantidad_diferencia').disabled = true;
document.getElementById('smn_unidad_medida_almacenaje_id').disabled = true;
