...
FROM smn_inventario.smn_despacho_detalle
	INNER JOIN smn_inventario.smn_caracteristica_item on smn_inventario.smn_caracteristica_item.smn_item_rf=smn_inventario.smn_despacho_detalle.smn_item_rf
