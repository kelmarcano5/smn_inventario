select
	...
	smn_inventario.smn_documentos.dcc_codigo||'-'||smn_inventario.smn_documentos.dcc_nombre as smn_documento_rf,
	smn_inventario.smn_movimiento_cabecera.mca_numero,
	smn_inventario.smn_proveedor.smn_auxiliar_rf||'-'||smn_inventario.smn_proveedor.prv_usuario_id as smn_proveedor_rf,
	smn_inventario.smn_orden_compra_cabecera.smn_orden_compra_cabecera_id||'-'||smn_inventario.smn_orden_compra_cabecera.occ_descripcion as smn_orden_compra_rf,
...
from
	...
	left outer join smn_inventario.smn_orden_compra_cabecera on smn_inventario.smn_orden_compra_cabecera.smn_orden_compra_cabecera_id = smn_inventario.smn_movimiento_cabecera.smn_orden_compra_rf
	left outer join smn_inventario.smn_documentos on smn_inventario.smn_documentos.smn_documentos_id = smn_inventario.smn_movimiento_cabecera.smn_documento_rf
	left outer join smn_inventario.smn_proveedor on smn_inventario.smn_proveedor.smn_proveedor_id = smn_inventario.smn_movimiento_cabecera.smn_proveedor_rf