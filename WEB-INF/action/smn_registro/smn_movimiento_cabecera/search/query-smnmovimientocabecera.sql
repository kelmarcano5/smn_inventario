select
	...
	case
		...
		when smn_inventario.smn_movimiento_cabecera.mca_estatus_proceso='RC' then 'Recibido'
	...
	smn_base.smn_almacen.alm_codigo||'-'|| smn_base.smn_almacen.alm_nombre as smn_almacen_rf_des,
smn_base.smn_sucursales.suc_codigo||'-'||smn_base.smn_sucursales.suc_nombre as smn_sucursal_rf,
	...
	smn_inventario.smn_documento.doc_nombre as doc_inventario
...
from
	...
	left outer join smn_compras.smn_documentos on smn_compras.smn_documentos.smn_documentos_id = smn_inventario.smn_movimiento_cabecera.smn_documento_origen_rf
