...
(
	...
	${fld:smn_auxiliar_ord_rf}, --smn_auxiliar_ord_rf
	${fld:smn_clase_auxiliar_ord_rf}, --smn_clase_auxiliar_ord_rf
	${fld:smn_orden_compra_rf}, --doc_orden_compra_rf
	...
	{d '${def:date}'}, --doc_fecha_comprobante
