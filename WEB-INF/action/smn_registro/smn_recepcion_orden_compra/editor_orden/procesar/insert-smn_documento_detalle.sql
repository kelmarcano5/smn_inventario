...
(
	...
	'${def:locale}', --dod_idioma
 	...
 	{d '${def:date}'}, --dod_fecha_registro
  	'${def:time}', --dod_hora
  	${fld:mde_monto_neto_ml}, --dod_monto_neto_ml
  	${fld:mde_monto_neto_ma}, --dod_monto_neto_ma
  	${fld:descripcion} --dod_descripcion_elemento
)