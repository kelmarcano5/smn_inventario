...
(
	nextval('smn_inventario.seq_smn_control_lote'), --smn_control_lote_id
  	...
  	${fld:coi_saldo_inicial_existencia}, --col_cantidad_inicial
  	${fld:coi_cantidad_entradas}, --col_entradas
  	${fld:coi_cantidad_salidas}, --col_salidas
  	${fld:coi_saldo_final_existencia}, --col_cantidad_final
