...
FROM smn_base.smn_almacen inner join smn_inventario.smn_caracteristica_almacen on smn_inventario.smn_caracteristica_almacen.smn_almacen_rf=smn_base.smn_almacen.smn_almacen_id
...
where smn_seguridad.s_user.userlogin='${def:user}' 
		and smn_base.smn_almacen.alm_empresa=${fld:id}
