...
--**** ACTUALIZA LOS IMPUESTOS DE LA TABLA -> smn_compras.smn_movimiento_detalle ****
...
WITH mde AS (
	...
	FROM 
		smn_inventario.smn_movimiento_detalle
	WHERE
		smn_inventario.smn_movimiento_detalle.smn_movimiento_cabecera_id=(SELECT smn_movimiento_cabecera_id FROM smn_inventario.smn_movimiento_detalle WHERE smn_movimiento_detalle_id = ${fld:smn_movimiento_detalle_id})
)
