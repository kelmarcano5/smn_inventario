select
	...
	smn_inventario.smn_movimiento_detalle.mde_descripcion ||' - '||	case 	when mde_tipo_movimiento = 'EN' then '${lbl:b_entrada}' 	when mde_tipo_movimiento = 'SA' then '${lbl:b_salida}' end	 ||' - '|| smn_inventario.smn_movimiento_detalle.mde_cantidad as smn_movimiento_detalle_id,
