select
	...
	when smn_inventario.smn_despacho_detalle.dde_estatus_transaccion='RE' then '${lbl:b_recorder}'
	...
	when smn_inventario.smn_despacho_detalle.dde_estatus_transaccion='SO' then '${lbl:b_solicited}'
