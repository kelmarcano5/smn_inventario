...
inner join smn_base.smn_sucursales on smn_base.smn_sucursales.smn_sucursales_id=smn_inventario.smn_control_lote.smn_sucursal_rf
where
	smn_control_lote_id is not null
	${filter}
order by
		smn_control_lote_id
